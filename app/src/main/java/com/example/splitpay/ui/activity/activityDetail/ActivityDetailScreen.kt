package com.example.splitpay.ui.activity.activityDetail
...
fun ActivityDetailScreen(
    ...
    Log.d("ActivityDetailScreen", "Received - activityId: $activityId, expenseId: $expenseId")
    ...
    Log.d("ActivityDetailScreen", "SavedStateHandle - activityId: ${savedStateHandle.get<String>("activityId")}, expenseId: ${savedStateHandle.get<String>("expenseId")}")
        ...
        currentEntry?.savedStateHandle?.let { savedState ->
            savedState.getStateFlow<Boolean?>("refresh_needed", null).collect { shouldRefresh ->
                if (shouldRefresh == true) {
                    Log.d("ActivityDetailScreen", "Refresh flag detected, refreshing data")
                    viewModel.refresh()
